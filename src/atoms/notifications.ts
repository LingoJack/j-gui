...
export async function updateNotificationsEnabled(enabled: boolean): Promise<void> {
  try {
    await ipc.updateSettings({ notificationsEnabled: enabled })
  } catch (error) {
...
export async function updateNotificationSoundEnabled(enabled: boolean): Promise<void> {
  try {
    await ipc.updateSettings({ notificationSoundEnabled: enabled })
  } catch (error) {
...
export async function updateNotificationSound(
  ...
  try {
    await ipc.updateSettings({ notificationSounds: newSounds })
  } catch (error) {
